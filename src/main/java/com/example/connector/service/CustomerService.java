...
public class CustomerService {
    ...
    private void syncNsFromDb(String accessToken, NetsuiteCustomerClient client, List<CustomerDto> dbCustomers,
                              List<CustomerDto> nsCustomers, List<CustomerDto> createdInNs) {
    ...
    public void syncCustomers(String accessToken, NetsuiteCustomerClient netsuiteCustomerClient) throws Exception {
        ...
        try {
            ...
            syncNsFromDb(accessToken, netsuiteCustomerClient, dbCustomers, nsCustomers, createdInNs);
            ...
            try {
                ...
                System.err.println("Failed to revert changed to NS, manually intervention required: " + e.getMessage());
            }
            throw e;
        }
    }
